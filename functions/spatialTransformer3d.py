...
class SpatialTransformer3D(Layer):
    ...
    def __init__(self, def_net, initial_map, output_size, **kwargs):
        self.defnet = def_net
    ...
    def call(self, X, mask = None):
        ...
        output = self._transform(transformation, self.initial_map, X, self.output_size)
        return output
    ...
    def _interpolate(self, image, initial_map, x, y, z, output_size):
        ...
        mapp = tf.tile(initial_map, tf.stack([batch_size, 1, 1, 3]))
    ...
    def _transform(self, transformation, initial_map, input_shape, output_size):
        ...
        transformed_image = self._interpolate(input_shape, initial_map, x_s_flatten, y_s_flatten, z_s_flatten, output_size)
